"use strict";
cc._RF.push(module, '42edb0VdwNDU4rEeO0WIG7d', 'ParamArea');
// scripts/component/ParamArea.js
...
cc.Class({
    ...
    paramEditBegin: function paramEditBegin() {
        cc.log("param edit begin");
    },
    paramEditEnd: function paramEditEnd() {
    ...
    grammarErr_ICheck: function grammarErr_ICheck() {
        this.grammarErr.active = false;
        this.jsStr.setFocus();
    },
    grammarErr_Rollback: function grammarErr_Rollback() {
        var editInfo = cc.editData.getCurEditRow();
        var jsStr = JSON.stringify(editInfo, null, 4);
        this.jsStr.string = jsStr;
        this.grammarErr.active = false;
    },
    paramEditReturn: function paramEditReturn() {
        cc.log("param edit return");
    },
    clear: function clear() {
        var curEditInfo = cc.editData.curEditInfo;
        cc.utils.alert("clear " + curEditInfo.type + " idx:" + curEditInfo.idx, function () {
