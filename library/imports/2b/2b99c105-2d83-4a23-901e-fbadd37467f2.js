"use strict";
cc._RF.push(module, '2b99cEFLYNKI5Ae+63TdGfy', 'LayerGrid');
// scripts/component/LayerGrid.js
...
cc.Class({
    ...
    start: function start() {
        ...
        cc.globalEvent.on("EditData:clearWantPlaceEntity", this.clearWantPlaceEntityHandle, this);
    },
    onDestroy: function onDestroy() {
        this._super();
        cc.globalEvent.off("EditData:clearWantPlaceEntity", this.clearWantPlaceEntityHandle, this);
    },
    clearWantPlaceEntityHandle: function clearWantPlaceEntityHandle(event) {
        this.hoverEntity.active = false;
    },
    mouseHoverHandle: function mouseHoverHandle(mousePos) {
    ...
    mouseDownHandle: function mouseDownHandle(mousePos) {
