"use strict";
cc._RF.push(module, '217b1WcJ5NHN57PtmJGLBhz', 'EditorLayerMgr');
// scripts/component/EditorLayerMgr.js
...
cc.Class({
    ...
    keyHandle: function keyHandle(keyObj) {
    ...
    updateList: function updateList(event) {
        ...
        if (detail.property.indexOf("roadMap") != -1 || detail.property.indexOf("updateRoad") != -1) {
            this.updateRoad();
        }
